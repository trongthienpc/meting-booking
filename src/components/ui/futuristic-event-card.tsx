...
import { Calendar, MapPin, Pencil, Trash2, User, Clock, ChevronDown, Activity } from "lucide-react";
...
export function FuturisticEventCard({ event, onEdit, onDelete }: EventCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          transform: `translate(${mousePosition.x / 10 - 20}px, ${mousePosition.y / 10 - 20}px)`,
        }}
      />
        ...
        <div className="relative p-6 text-white">
          <div className="flex items-start gap-6">
            ...
            <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-sm rounded-2xl p-3 min-w-[80px]">
              ...
              <span className="text-xs font-medium text-blue-300">{dayOfWeek}</span>
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="mt-3 flex flex-wrap gap-3">
                ...
                <div className="flex items-center gap-1.5 bg-white/10 backdrop-blur-sm rounded-full px-3 py-1 text-xs">
                  ...
                  <span className="truncate max-w-[150px]">{event.Room?.name}</span>
                </div>
          ...
          <div className="mt-6 mb-2">
            ...
            <div className="relative h-1.5 bg-gray-700 rounded-full overflow-hidden" ref={timelineRef}>
              <motion.div
          ...
          <div className="mt-4 flex justify-center">
            <Button variant="ghost" size="sm" className="" onClick={() => setIsExpanded(!isExpanded)}>
              <span className="text-xs mr-1">{isExpanded ? "Thu gọn" : "Chi tiết"}</span>
            ...
            {isExpanded && (
              ...
              >
                  ...
                  <div className="space-y-3">
                    {event.Creator?.Department?.name && (
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm">{event.Creator?.Department?.name}</div>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm">{event.description || "Chưa có ghi chú"}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4 flex justify-end gap-2">
                  <Button variant="default" size="sm" className="text-white" onClick={() => onEdit(event)}>
                    <Pencil className="w-3.5 h-3.5 mr-1" />
                    Chỉnh sửa
                  </Button>
                  <Button variant="destructive" size="sm" className="" onClick={() => onDelete()}>
